...
export default function Dashboard() {
  ...
  const emergencyContacts = [
    ...
    { name: "Therapist", number: "Dr.Sharma - (555) 123-4567" },
  ];
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:"Hello Adi, how’s your day going?",
      timestamp: new Date(Date.now() - 1000 * 60 * 5),
    },
    {
      role: "user",
      content: "I’m worried about how my presentation will go.",
      timestamp: new Date(Date.now() - 1000 * 60 * 4),
    },
    {
      role: "assistant",
      content:
        "Presentations can be nerve-wracking. Want to do a short breathing exercise with me?",
  ...
  const wellnessStats = [
    {
      ...
      description: "Today’s Mood Overview",
    },
    {
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            We care about your privacy — please authenticate to proceed.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-background">
      ...
      <Container className="pt-20 pb-8 space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <h1 className="text-3xl font-bold text-foreground">
              Hi {user?.name || "Sir"}, ready for today’s calm moment?
            </h1>
            <p className="text-muted-foreground">
        ...
        {showCrisisAlert && (
          <Alert variant="destructive" className="animate-pulse">
            ...
            <AlertTitle>Support available 24/7 for urgent help</AlertTitle>
            <AlertDescription>
              It seems you’re having a tough time. Support is available anytime, day or night.
              <div className="mt-2">
                <Button variant="secondary" className="mr-2">
                  <PhoneCall className="mr-2 h-4 w-4" />
                  Speak with a Support Specialist
                </Button>
                <Button variant="outline">Chat with a Therapist</Button>
              </div>
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <CardContent className="p-6 relative">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Simple Wellness Tools</h3>
            ...
            <Card className="border-primary/10">
              <CardHeader>
                <CardTitle>Today’s Wellness Summary</CardTitle>
                <CardDescription>
                  Your mental health summary for {format(new Date(), "MMMM d, yyyy")}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
            ...
            <Card className="border-primary/10">
              <CardHeader>
                ...
                <CardDescription>
                  Customized tips from your activity data
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {aiInsights.length > 0 ? (
                    ...
                    <div className="text-center text-muted-foreground py-8">
                      ...
                      <p>
                        Complete tasks to receive your personal wellness tips
                      </p>
                    </div>
                  )}
                </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Watch your health trends and get personal suggestions
                      </p>
                    </div>
                  ...
                  <div className="mt-4 flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>Feature integration arriving shortly – stay tuned!</span>
                  </div>
                </CardContent>
              </Card>
            ...
            <div>
              <Card className="border-primary/10">
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Recent Activities */}
                  <div className="space-y-4">
                    <h4 className="font-medium text-sm">Latest Actions</h4>
                    <div className="space-y-2">
      ...
      <Dialog open={showMoodModal} onOpenChange={setShowMoodModal}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>How’s Your Mood?</DialogTitle>
            <DialogDescription>
              Adjust the slider for your feelings
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="fixed inset-y-0 right-0 w-full max-w-sm bg-background border-l shadow-lg">
            <div className="flex h-full flex-col">
              <div className="flex items-center justify-between px-4 py-3 border-b">
                <h3 className="font-semibold">Smart Check-In</h3>
                <Button
                  variant="ghost"
                  size="icon"
